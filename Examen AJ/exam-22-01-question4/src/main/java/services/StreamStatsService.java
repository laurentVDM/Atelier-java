...
public class StreamStatsService extends Thread {
    ...
    private Supplier<Stream<FirstnameImpl>> namesSupplier;
    private Supplier<Stream<CityImpl>> citiesSupplier;

    public StreamStatsService(Collection<FirstnameImpl> firstnames, Collection<CityImpl> cities) {
     ...
     */
    public List<FirstnameImpl> getLongestFirstnames(int max) {
        // TODO question 2
        return null;
    }
     ...
     */
    private CityImpl cityWithMaxFemaleNames() {
        // TODO question 2
        return null;
    }
