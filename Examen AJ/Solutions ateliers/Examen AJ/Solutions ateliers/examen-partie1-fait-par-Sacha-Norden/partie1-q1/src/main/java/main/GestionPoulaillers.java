...
public class GestionPoulaillers {
  ...
  public static void main(String[] args) {
    ...
    VenteOeufs v1 = new VenteOeufs(LocalDate.of(2022, 9, 30), 83500,0.15, Acheteur.DELHAIZE);
    VenteOeufs v2 = new VenteOeufs(LocalDate.of(2022,9,5), 27000, 0.2, Acheteur.DELHAIZE);
    VenteOeufs v3 = new VenteOeufs(LocalDate.of(2022, 9, 9), 27500,0.2, Acheteur.CARREFOUR);
    VenteOeufs v4 = new VenteOeufs(LocalDate.of(2022, 9, 10), 144,0.35, Acheteur.JETJ);
    VenteOeufs v5= new VenteOeufs(LocalDate.of(2022, 9, 10), 288,0.35, Acheteur.ROSEMARIE);
    VenteOeufs v6 = new VenteOeufs(LocalDate.of(2022, 9, 23), 49000,0.2, Acheteur.CARREFOUR);
    VenteOeufs v7 = new VenteOeufs(LocalDate.of(2022, 9, 10), 12,0.4, Acheteur.PARTICULIER);
    ...
    VenteOeufs v8 = new VenteOeufs(LocalDate.of(2022,9,30), 3000, 0.4, Acheteur.CARREFOUR);
    VenteOeufs v9 = new VenteOeufs(LocalDate.of(2022,9,23), 1500, 0.4, Acheteur.DELHAIZE);
    ...
    VenteOeufs v10 = new VenteOeufs(LocalDate.of(2022, 9, 10), 48,1, Acheteur.JETJ);
    VenteOeufs v11 = new VenteOeufs(LocalDate.of(2022, 9, 10), 96,1, Acheteur.ROSEMARIE);
