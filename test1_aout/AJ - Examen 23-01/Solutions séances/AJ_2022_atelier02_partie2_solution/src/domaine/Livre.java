        ...
        if (plats == null) {
            plats = new TreeSet<Plat>(new Comparator<Plat>() {
                ...
                public int compare(Plat o1, Plat o2) {
                    int comp = Integer.compare(o1.getNiveauDeDifficulte().ordinal(), o2.getNiveauDeDifficulte().ordinal());
                    if (comp == 0) return o1.getNom().compareTo(Fo2.getNom());
                    return comp;
                }
            });
