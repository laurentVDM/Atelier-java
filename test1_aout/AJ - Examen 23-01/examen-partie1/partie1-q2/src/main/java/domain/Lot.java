...
public class Lot {
  ...
  private String race;
  private HashSet<VenteOeufs> ventes = new HashSet<VenteOeufs>();
  ...
  public Set<VenteOeufs> getVentes() {
    return Collections.unmodifiableSet(ventes);
  }
}
