...
public class GestionPoulaillers {
  ...
  public static void main(String[] args) {
    ...
    VenteOeufs v1 = new VenteOeufs(LocalDate.of(2022, 9, 30), 83500,0.15, Acheteur.CARREFOUR);
    VenteOeufs v2 = new VenteOeufs(LocalDate.of(2022,9,5), 27000, 0.2, Acheteur.DELHAIZE);
    VenteOeufs v3 = new VenteOeufs(LocalDate.of(2022, 9, 9), 27500,0.2, Acheteur.DELHAIZE);
