...
public class Ferme {
  ...
  public enum Acheteur {
    DELHAIZE("Carrefour", "Supermarché"),
    CARREFOUR("Delhaize","Supermarché"),
    JETJ("JetJ","Epicerie"),
    ROSEMARIE("Rosemarie","Epicerie"),
    ...
    Acheteur(String nomAcheteur) {
      this.nom = nomAcheteur;
      this.type = "Particulier";
    }
    Acheteur(String nomAcheteur, String typeAcheteur) {
      this.nom = nomAcheteur;
      this.type = typeAcheteur;
    }
